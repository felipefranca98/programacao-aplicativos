...
public class RendimentoDAO {
	...
	public List<Rendimento> buscarRendimento(int id) throws SQLException {
	...
	public int buscarIdRendimento(Rendimento rendimento) throws SQLException {
		...
		try {
			...
			st = conn.prepareStatement("select Id from rendimento where User = ? and Mes = ? and Ano = ? and Categoria = ? and Rendimento = ? and Mensal = ? and Ocasional = ? and Total = ? order by Id");
