...
public class ResumoAno {
	...
	private double rendimentoOcasional;
	private double investimentoTotal;
	private double investimentoMensal;
	private double investimentoOcasional;
	private double fundoDespesaTotal;
	private double fundoDespesaMensal;
	private double fundoDespesaOcasional;
	private double valorDisponivelAno;
	...
	public double getFundoDespesaMensal() {
	...
	public double getFundoDespesaOcasional() {
